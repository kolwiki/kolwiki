...
public class ThingArrayAdapter extends ArrayAdapter<Thing> {
	private final static String TAG = "ThingArrayAdapter";
	
	private final Context context;
	private final Thing[] things;
 
	public ThingArrayAdapter(Context context, Thing[] things) {
		super(context, R.layout.activity_viewer, things);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		textView.setText(things[position].getName());
		Log.d(TAG, "Creating view for thing named " + things[position].getName());
 
		ViewHolder holder = new ViewHolder();
		holder.thumbnail = imageView;
		holder.position = position;
		holder.url = things[position].getUrl();
